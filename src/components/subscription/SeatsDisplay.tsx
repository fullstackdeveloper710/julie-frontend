      ...
      <div className="space-y-4">
        <div>
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium text-gray-600">Manager Seats</span>
            <span className="text-sm font-semibold text-gray-900">
              {seatUsage.managerSeats.used} / {seatUsage.managerSeats.total}
            </span>
          </div>
          <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
            <div
              className="h-full bg-blue-500 transition-all"
              style={{ width: `${seatUsage.managerPercent}%` }}
            />
          </div>
          <p className="text-xs text-gray-500 mt-1">{seatUsage.managerSeats.available} available</p>
        </div>
      </div>

      {seatUsage.managerSeats.available > 0 && (
