...
export default function HeroSection() {
    return (
        <section
            ...
            style={{
                background: 'linear-gradient(135deg, rgb(15, 25, 34) 0%, rgb(26, 42, 58) 50%, rgb(15, 25, 34) 100%)',
            }}
        >
            ...
            <div
                ...
                style={{
                    backgroundImage: 'linear-gradient(rgba(46, 64, 85, 0.15) 1px, transparent 1px), linear-gradient(90deg, rgba(46, 64, 85, 0.15) 1px, transparent 1px)',
            ...
            <div
                ...
                style={{
                    background: 'radial-gradient(at 30% 50%, rgba(240, 90, 40, 0.08) 0%, transparent 60%), radial-gradient(at 70% 50%, rgba(44, 62, 80, 0.15) 0%, transparent 60%)',
                }}
            />
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center">
                ...
                <p className="text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-8">
                    Frontline Frameworks gives public safety agencies a structured monthly diagnostic system that turns operational data into AI-powered workforce intelligence — so leaders can act before problems escalate.
                </p>
