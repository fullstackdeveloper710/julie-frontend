  ...
  return (
    <section className="bg-linear-to-b from-slate-800 to-slate-900 border-t border-slate-800 py-16 px-4">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="font-bold text-2xl text-white mb-2">Not Ready to Subscribe Yet?</h2>
        <p className="text-sm mb-6">
          Leave your name and email and we'll send you a platform overview and sample intelligence
          report.
        </p>
