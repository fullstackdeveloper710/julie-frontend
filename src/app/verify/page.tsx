...
export default function VerifyPage() {
    ...
    useEffect(() => {
        ...
        // Skip the network call if this token already succeeded earlier in this
        // browser session (covers React 18 StrictMode double-mount in dev mode
        // and double-clicks on the email link).
